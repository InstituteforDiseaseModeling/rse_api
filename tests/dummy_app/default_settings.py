...
DEBUG = (
    os.environ.get("DEBUG", "False").lower() in TRUE_OPTIONS
    or os.environ.get("FLASK_ENV", "production") == "development"
)
LOG_DIR = "."  # create log files in current working directory
SQLALCHEMY_TRACK_MODIFICATIONS = (
    os.environ.get("SQLALCHEMY_DATABASE_URI", "False").lower() in TRUE_OPTIONS
)
